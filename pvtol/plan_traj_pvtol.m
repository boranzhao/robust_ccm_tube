...
if trajGen_config.include_obs == 1
    ...
    % yrange = [1 9];
    % rrange = [0.4 0.8];
    % obstacles = generate_obs(num_obs,xrange,yrange,rrange);
    % save('obstacle_3.mat','obstacles')
    % load('obstacle_3.mat','obstacles');
    ...
    stateCst = @(x)  cst_avoid_obstacle(x,trajGen_config.obs,tube_xz);
