...
line_wd = 1.5;      %
plot_rst_w_obs = 0; % whether to plot the results with obstacles
...
if sim_config.include_obs == 0    
    ...
    txt = text(-1.5,7.2,'Wind','Fontsize',13,'Color','r');
...
elseif sim_config.include_obs == 1
    ...
    txt = text(-0.7,7.3,'Wind','Fontsize',13,'Color','r');
    xlabel('$p_x$ (m)','interpreter','latex');
    ylabel('$p_z$ (m)','interpreter','latex')

end
txt_start = text(-1,-1,'Start','Fontsize',13);
